...
function InputField({
  id, label, type, autoComplete, required, value, onChange, placeholder, extra,
}: {
        ...
        <div className="flex items-end gap-8">
          <div>
            ...
            <p className="mt-8 max-w-xs text-[13px] leading-relaxed text-[#999999]">
              Build real Python confidence through adaptive conversations that adapt to how well you actually understand — not just what you've read.
            </p>
          </div>
